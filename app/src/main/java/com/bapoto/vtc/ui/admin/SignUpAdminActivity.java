...
import com.bapoto.bapoto.databinding.ActivitySignupAdminBinding;
...
public class SignUpAdminActivity extends AppCompatActivity {
    ...
    private void setListeners() {
        ...
        binding.textAddAdmin.setOnClickListener(view -> startActivity(new Intent(this, SignUpAdminActivity.class)));
    }
